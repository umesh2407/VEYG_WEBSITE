...
import { redirectToCodexForm } from "../redirect";
    ...
    <div className="wrapper">
      ...
      >
        ...
        <a
           ...
           target="_blank"
          className="m-hide text-focus-in w-[150px] h-[47px] pl-[3px] pr-[13px] mr-[5rem] bg-[#6C0FE4] from-zinc-950  rounded-full shadow border border-[#6C0FE4] justify-start items-center inline-flex instagram-button mb-[0.5rem]"
        >
          ...
          <div className="relative flex justify-center">
            <div className="flex justify-center codex-btn cursor-pointer absolute z-10 mx-auto bottom-32">
              <div className="flex justify-center">
                <div onClick={redirectToCodexForm} className="w-[235px] h-[65px] text-center flex flex-row justify-center items-center left-0 top-0 bg-[#6C0FE4] rounded-[100px] m-codex-btn">
        ...
        <div className="valorantmapselection w-[950px] m-mapselection">
          <div className="p-[10px] flex flex-col gap-3 text-[#D4D4D4] tracking-[1.15px] text-[20px] font-inter text-center m-map-rules">
            ...
            >
              <li>
                {" "}
                Participants will be provided with PC and necessary equipments.
              </li>
              <li>
                {" "}
                Participants must not share code or collaborate with others
                during the event.
              </li>
              <li>
                {" "}
              ...
              <li>
                {" "}
                The event organizers reserve the right to disqualify any
                participant who violates the rules.
              </li>
              <li>
                {" "}
                The event organizers reserve the right to make final decisions
                on any disputes or ambiguities that may arise.
              </li>
              <li>
                {" "}
                The event will have a specific time limit and the submission
                should be done in the given time frame.
              </li>
              <li>
                {" "}
                The event organizers will provide the problem statement and the
                input-output format in which the solution should be written.
              </li>
              <li>
                {" "}
                Participants are expected to follow the format provided in the
                problem statement while submitting their solutions.
              </li>
              <li>
                {" "}
                The solutions will be evaluated based on correct output and the
                time of submission.
              </li>
            </ul>
          </div>
...
export default transition(Codex);