...
import { redirectToTechnutzForm } from "../redirect.js";
import Technutzloader from "../Technutzloader.js";
...
const Technutz = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Ziegers-Technutz";
    ...
    <div className="wrapper">
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="m-hide text-focus-in w-[150px] h-[47px] pl-[3px] pr-[13px] mr-[5rem] bg-[#FA00FF] from-zinc-950  rounded-full shadow border border-[#FA00FF] justify-start items-center inline-flex instagram-button mb-[0.5rem]"
        >
          ...
          <div className="relative flex justify-center">
            <div className="flex justify-center technutz-btn cursor-pointer absolute z-10 mx-auto bottom-32">
              <div className="flex justify-center">
                <div onClick={redirectToTechnutzForm} className="w-[235px] h-[65px] text-center flex flex-row justify-center items-center left-0 top-0 bg-[#FA00FF] rounded-[100px] m-technutz-btn">
      ...
      <div className="max-w-[1300px] lg:mt-40 mb-20 flex flex-col justify-center items-center mx-auto gap-10">
        ...
        <section className="w-[1000px] flex flex-col items-center gap-6">
          ...
          <div className="font-inter text-[23px] text-white text-center tracking-[0.5px] m-technutz-overview">
            ...
            everyone has a fair and good time, it is crucial that participants
            be aware of the regulations prior to the event.
          </div>
        </section>
      </div>
      <Footer/>
...
export default transition(Technutz);