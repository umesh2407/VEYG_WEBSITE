...
const About = () => {
  return (
    ...
    <p className='mb-6'>Welcome to VEYG, Saffrony Institute’s Technical Festival! Explore a platform where budding Saffronites unfold their engineering potential, refine soft skills, and gain recognition for their discipline and outstanding performance. 💡</p>
</div>
